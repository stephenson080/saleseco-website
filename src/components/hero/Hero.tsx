    ...
    return (
        <div className="relative h-full flex flex-col space-y-[2rem] justify-center items-center">
            ...
            <div className="text-center">
                <h1 className="font-inter-extrabold text-[2.75rem] mb-[2rem]">
                    Buyers with <span className="inline-block text-[#3b82f6]">Budget</span>. Sellers
                    with <span className="inline-block text-[#3b82f6]">Solutions</span>.
                </h1>

                <p className="text-[1.5rem]">
                    SalesEco connects real buyers and verified sellers-no fluff, no fraud, just
            ...
            <div>
                <button className="bg-btn-active flex items-center gap-4 py-[1.5rem] px-[2.5rem] rounded-[1.5rem] text-white">
