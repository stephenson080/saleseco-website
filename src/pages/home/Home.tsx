...
import { DEP_ID, EMAILJS_PUBLIC_KEY, EMAILJS_SERVICE_ID, EMAILJS_TEMPLATE_ID } from '../../lib/env';
...
const ContactForm = () => {
    ...
    return (
        <form ref={formRef} onSubmit={sendEmail} className="space-y-6 w-full max-w-lg mx-auto">
            <h2 className="font-inter-bold text-[2rem] mb-2 text-blue-600 text-center">
                Contact Us
            </h2>
            <input
                type="text"
                ...
                placeholder="Name"
                required
                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-400 text-[1.15rem]"
            />
            <input
                type="email"
                name="user_email"
            ...
            <textarea
                ...
                required
                rows={6}
                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-400 text-[1.15rem] resize-vertical min-h-[120px]"
            />
            <button
                type="submit"
                className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold text-[1.15rem] hover:bg-blue-700 transition">
                Send
            </button>
                ...
                <div className="space-y-[2rem] md:space-y-0 md:flex md:justify-center gap-[3.5rem] items-center">
                    ...
                    <motion.div
                        ...
                        onClick={() =>
                            openModal(
                                <div>
                                    <h2 className="font-inter-bold text-[2rem] mb-4 text-blue-600">
                            ...
                            <motion.div
                                ...
                                onClick={() =>
                                    openModal(
                                        <div>
                                            <h2 className="font-inter-bold text-[2rem] mb-4 text-blue-600">
                                                Step 1: State your shopping budget or inventory list
                                            </h2>
                                            <p className="text-[1.25rem] md:text-[1.5rem]">
                                                Let us know what you are planning on buying or
                                                selling.
                                            </p>
                                        </div>
                                    )
                            ...
                            <motion.div
                                ...
                                onClick={() =>
                                    openModal(
                                        <div>
                                            <h2 className="font-inter-bold text-[2rem] mb-4 text-blue-600">
                                                Step 2: Get Matched With the Right Users
                                            </h2>
                                            <p className="text-[1.25rem] md:text-[1.5rem]">
                                                SalesEco connects you based on category, budget,
                                                gender, and location.
                                            </p>
                                        </div>
                                    )
                            ...
                            <motion.div
                                ...
                                onClick={() =>
                                    openModal(
                                        <div>
                                            <h2 className="font-inter-bold text-[2rem] mb-4 text-blue-600">
                                                Step 3: Shop or Sell to Active Verified Users
                                            </h2>
                                            <p className="text-[1.25rem] md:text-[1.5rem]">
                        ...
                        {[
                            ...
                            <motion.div
                                ...
                                <div className="space-y-[.85rem]">
                                    ...
                                    <p className="text-[1.45rem] md:text-[1.65rem]">{perk.desc}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
